...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex" style={{ fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
      ...
      {/* LEFT — exactly 50% white, register card centered inside */}
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white px-8 py-10">
        <div className="w-full max-w-[400px] flex flex-col">
          ...
          {/* Headline */}
          <h1 className="text-[#172B4D] font-bold text-[28px] leading-[1.25] mb-6">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-[#172B4D] text-sm font-semibold">Full name</label>
            ...
            {/* Confirm password */}
            <div className="flex flex-col gap-1.5">
              <label className="text-[#172B4D] text-sm font-semibold">Confirm password</label>
              <div className="relative">
                <div className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#6B778C]">
                  <Lock size={16} />
                </div>
            ...
            {/* Terms */}
            <p className="text-xs text-[#6B778C] leading-relaxed -mt-1">
              By signing up, you agree to our{" "}
              <span className="text-[#1868DB] cursor-pointer hover:underline">Privacy Policy</span>{" "}
              and{" "}
              <span className="text-[#1868DB] cursor-pointer hover:underline">Terms of Service</span>.
            </p>
          ...
          {/* Login link */}
          <p className="text-sm text-[#6B778C] mt-5">
            Already have an account?{" "}
            <Link to="/login" className="text-[#1868DB] font-semibold hover:underline">
              Log in
            </Link>
          </p>

          {/* Footer */}
          <p className="text-[#6B778C] text-xs mt-8">
