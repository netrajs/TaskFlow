...
const Dashboard = () => {
  ...
  const statsConfig = [
    { label: "My Tasks", value: stats?.totalTasks || 0, icon: BarChart2, border: "border-blue-500", iconColor: "text-blue-500" },
    ...
    <div className="p-6 space-y-6 max-w-[1400px] mx-auto">
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm space-y-4">
        <div className="flex justify-between items-center">
          ...
          <Link to="/user/tasks" className="text-blue-600 hover:underline text-sm font-medium">
            See All &rarr;
          </Link>
        </div>
